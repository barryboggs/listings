...
/**
 * Read the cached access token. Used by the integration token-broker
 * endpoint so external apps can call Semrush directly without holding
 * their own copy of the refresh-token chain. tokenCache is module-scope
 * and not exported; this getter is the only sanctioned way out.
 */
